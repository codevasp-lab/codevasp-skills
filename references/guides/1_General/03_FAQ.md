...
## 6. How should API withdrawals be handled to comply with the Travel Rule?
...
## 7. Why is verifying the Beneficiary VASP important, and how is it done?
...
## 8. Recipient Policy: Minimize risk, maximize opportunity
...
## 9. On-chain Analysis vs. Travel Rule Verification
...
## 11. What is the CodeVASP Cipher Module, and how should it be used?
...
## 12. Is it mandatory to use the CodeVASP Cipher module?
...
## 13. How often should the VASP List Search API be called?
...
## 14. What field should `accountNumber` contain — the user's wallet address or the exchange's wallet address?
...
## 15. Should `currency` be the network symbol or the coin symbol?
...
## 16. How should `tradePrice` and `tradeCurrency` be calculated and entered?
...
## 17. What are the required fields in IVMS101?

Please refer to the `Dev 04 - IVMS101` documentation for a full breakdown of required and optional fields across all person types (natural and legal) for both the Originator and Beneficiary.

## 18. What is Request API and Response API?
